...
export default function BouncingLink ({ helper, linkText, direction }) {
  ...
  return (
    <div className='flex justify-center mt-auto mb-10 transition transform -translate-y-2 duration-1500 transform-gpu group animate-bounce justify-self-end hover:animate-none' onClick={helper}>
