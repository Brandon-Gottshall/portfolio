...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-navy focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-navy text-cream hover:bg-navy/90",
        secondary:
          "border-transparent bg-red text-cream hover:bg-red/90",
        destructive:
          "border-transparent bg-red-dark text-cream hover:bg-red-dark/90",
