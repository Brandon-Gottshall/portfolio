export default function BouncingArrow({
  ...
  return (
    <div
      className={
        'flex justify-center transition transform cursor-pointer duration-1500 transform-gpu group animate-bounce hover:animate-none ' +
        contClassName
      }
      onClick={helper}
    >
      <svg
        className={svgClassNameConcat}
        fill="none"
