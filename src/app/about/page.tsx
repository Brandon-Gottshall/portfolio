  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-light mb-8 tracking-tight text-navy dark:text-cream">About Me</h1>

        {/* Introduction Section - using regular weight for better readability */}
        <section className="mb-16">
          <p className="text-lg text-gray mb-6 leading-relaxed">
            I&apos;m Brandon Gottshall, a <span className="font-code">software engineer</span> passionate about creating elegant solutions 
            to complex problems. With a focus on <span className="font-code">modern web technologies</span>, I specialize in building 
        ...
        {/* Philosophy Section */}
        <section className="mb-16">
          <h2 className="text-2xl font-light mb-6 tracking-tight text-navy dark:text-cream">My Philosophy</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="p-6 rounded-xl border border-navy/10 dark:border-cream/10">
              <h3 className="text-xl font-light mb-3 text-navy dark:text-cream">User-First</h3>
              <p className="text-gray dark:text-tan">
        ...
        {/* Interests Section */}
        <section className="mb-16">
          <h2 className="text-2xl font-light mb-6 tracking-tight text-navy dark:text-cream">Beyond Coding</h2>
          <div className="p-6 rounded-xl border border-navy/10 dark:border-cream/10">
            ...
            <ul className="list-disc list-inside text-gray dark:text-tan space-y-2">
              <li>
                Exploring new <span className="font-code">technologies</span> and <span className="font-code">frameworks</span>
              </li>
              <li>
                Contributing to <span className="font-code">open-source</span> projects
              </li>
        ...
        <section>
          <div className="p-8 rounded-xl bg-navy/5 dark:bg-navy text-center">
            <h2 className="text-2xl font-light mb-4 tracking-tight text-navy dark:text-cream">Let&apos;s Connect</h2>
