import { Chart as ChartJS, ChartType, ChartData, ChartOptions, Point } from 'chart.js';

declare module 'chart.js' {
  interface TooltipModel<TType extends ChartType = ChartType> {
    setActiveElements(elements: Array<{ datasetIndex: number; index: number }>, eventPosition: { x: number; y: number }): void;
    active: boolean;
  }
  ...
  interface ChartInstance<TType extends ChartType = ChartType> extends ChartJS<TType> {
